      ...
      >
        <ul>
          ...
          <NavDropdown title="IP" id="collasible-nav-dropdown">
            <NavDropdown.Item href="#">Imobiliário</NavDropdown.Item>
            <NavDropdown.Item href="#">Saúde</NavDropdown.Item>
            <NavDropdown.Item href="#">Vida</NavDropdown.Item>
          </NavDropdown>
          <li>Câmbio</li>
          <NavDropdown title="Operacional" id="collasible-nav-dropdown">
            <NavDropdown.Item href="#">Marketing</NavDropdown.Item>
            <NavDropdown.Item href="#">Recursos Humanos</NavDropdown.Item>
